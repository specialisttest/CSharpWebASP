...
public class CoinsData: ICoinData {
    ...
    public void ReplaceCoinData(Coin obj) {
        int id = obj.Id-1;
        coins[id].Comment = obj.Comment;
        coins[id].Country = obj.Country;
        coins[id].Denomination = obj.Denomination;
        coins[id].Face  = obj.Face;
        coins[id].Metal = obj.Metal;
        coins[id].Year  = obj.Year;
    }
}